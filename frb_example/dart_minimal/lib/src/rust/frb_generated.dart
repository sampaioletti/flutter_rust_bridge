...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -369053011;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> crateApiMinimalSleepFn(
      {required FutureOr<void> Function(int) sleepCb});
}
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<void> crateApiMinimalSleepFn(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiMinimalSleepFnConstMeta,
      argValues: [sleepCb],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiMinimalSleepFnConstMeta => const TaskConstMeta(
        debugName: "sleep_fn",
        argNames: ["sleepCb"],
      );
